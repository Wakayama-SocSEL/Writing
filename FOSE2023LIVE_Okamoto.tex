...
\Jabstract{
Scratchでは，プログラムの類似性とオブジェクト動作軌跡の類似性が乖離する作品が存在し，検索における作品収集の妨げになることが示唆されるが，乖離の度合いは明らかになっていない．本研究では,ケーススタディとして4,000件のScratch作品を対象に類似性の乖離する作品を分析した結果，プログラムが類似してオブジェクト動作軌跡が類似しない作品は全体の約1\%，オブジェクト動作軌跡が類似してプログラムが類似しない作品は全体の約28\%存在することを確認した．
}
%
