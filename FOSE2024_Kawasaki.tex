...
\subsection{開催概要}
% FIXME
\foseabbrev\cite{fose2024}は以下の要領で開催する予定です.
\begin{description}
\item[日程] 2024年11月28日(木) -- 30日(土)
\item[場所] ホテル龍登園\\
{\footnotesize
...
そこで，FOSE2023から「コンピュータソフトウェア」の体裁に近づけたフォーマットを新たに作成しました．
...
修正したファイルは以下の3つです．
\begin{itemize}
	\item compsoft.cls （fose.clsにリネームしただけ）
	\item compsoft.sty （fose.styにリネーム後修正）
...
年度の指定のために，4行目を以下のように変更しています（2024年度の例です）．
...
\cite{fose2024}
．
これは{\texttt cite}パッケージを使用した場合の例です\cite{fose2016,fose2017,fose2018,fose2019,fose2020,fose2021,fose2022,fose2023,fose2024}．
