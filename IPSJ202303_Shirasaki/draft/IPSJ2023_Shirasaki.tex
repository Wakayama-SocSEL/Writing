...
\begin{figure}[t]
\begin{center}
%\includegraphics[width=6cm]{IPSJ202303_Shirasaki/draft/1commit_use_aliyun_1.pdf}
...
\begin{center}
%\includegraphics[width=6cm]{IPSJ202303_Shirasaki/draft/1commit_use_js_1.pdf}
...
\begin{thebibliography}{1}
  \bibitem{bib1} Gede Artha Prana, Christoph Treude, Ferdian Thung, Thushari Atapattu, and David Lo. 2019. Categorizing the Content of GitHub README Files. Empirical Software Engineering. vol.24, no.3, 1296-1327, 2019. 
  \bibitem{bib2} J. Moreno-Le'on, G. Robles, and M. Rom'an-Gonz'alez, ``Dr. scratch: Automatic analysis of scratch projects to assess and foster computational thinking,'' RED.Revista de Educaci'on a Distancia, vol.15, no.46, pp.1-23, 2015.
