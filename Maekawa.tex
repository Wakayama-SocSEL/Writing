...
\begin{figure}[t]
  ...
  \centering
  \includegraphics[width=1.0\linewidth]{Maekawa_fig/barh-test-pattern.pdf}
...
\begin{figure}[t]
  ...
  \centering
  \includegraphics[width=1.0\linewidth]{Maekawa_fig/rq1/set-map/map.pdf}
  \includegraphics[width=1.0\linewidth]{Maekawa_fig/rq1/set-map/map.test.pdf}
...
\begin{figure}[t]
  ...
  \centering
  \includegraphics[width=1.0\linewidth]{Maekawa_fig/rq1/uuid/randomByte.pdf}
  \includegraphics[width=1.0\linewidth]{Maekawa_fig/rq1/uuid/randomByte.test.pdf}
...
\begin{figure}[t]
  ...
  \centering
  \includegraphics[width=1.0\linewidth]{Maekawa_fig/teiannshuhou.pdf}
